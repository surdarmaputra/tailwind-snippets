  ...
  return (
    <section className="container mx-auto flex flex-col px-8 py-36 sm:flex-row-reverse sm:px-12">
      ...
      <div className="mr-4 w-full text-center sm:w-1/2 sm:text-left">
        ...
        <button className="rounded-lg border-0 bg-pink-400 px-12 py-2 text-base text-white shadow-lg shadow-pink-300 transition hover:bg-pink-500 hover:shadow-pink-400">
          Register now
        </button>
      </div>
    </section>
